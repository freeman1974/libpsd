...
/////////////////////////////////////////////////////////////////////////////////////////////
					...
					default:
						...
						// contains a Pascal每style string containing the name of the clipping path to use with this
...
Image resources are used to store non每pixel data associated with an image, such as pen tool paths.
Table 2每1: Image resource block
Type 	Name Description
OSType 	Type Photoshop always uses its signature,8BIM.
int16 	ID Unique identifier (see table 10每2).
